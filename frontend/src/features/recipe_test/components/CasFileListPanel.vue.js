...
__VLS_asFunctionalElement1(__VLS_intrinsics.section, __VLS_intrinsics.section)(__assign(__assign(__assign(__assign({ onMousedown: function () {
        ...
        // @ts-ignore
        [emit,];
    } }), { class: "w97-panel cas-panel" }), { class: ({ 'pane-focus': __VLS_ctx.paneFocus }) }), { style: (__VLS_ctx.panelStyle) }));
...
__VLS_asFunctionalElement1(__VLS_intrinsics.input)(__assign(__assign(__assign(__assign(__assign({ onInput: function () {
        ...
        // @ts-ignore
        [emit,];
    } }), { class: "win-input w97-find" }), { class: ([__VLS_ctx.queryClass, { compact: __VLS_ctx.findCompact }]) }), { value: (__VLS_ctx.modelValue), placeholder: "예: CAS40" }));
/** @type {__VLS_StyleScopedClasses['win-input']} */ ;
/** @type {__VLS_StyleScopedClasses['w97-find']} */ ;
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)(__assign(__assign({ onClick: function () {
        ...
        __VLS_ctx.emit('search');
        // @ts-ignore
        [emit, queryClass, findCompact, modelValue,];
...
for (var _i = 0, _a = __VLS_vFor((__VLS_ctx.headerCount)); _i < _a.length; _i++) {
    var idx = _a[_i][0];
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign(__assign({ key: ("cas-head-".concat(idx)) }, { class: "w97-col list-col-wide head-wide" }), { style: ({ width: __VLS_ctx.columnBlockWidth + 'px' }) }));
    ...
    if (__VLS_ctx.listMode === 'detail') {
        __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign(__assign({ onClick: function () {
                ...
                if (!(__VLS_ctx.listMode === 'detail'))
                    return;
                __VLS_ctx.emit('toggle-sort', 'name');
                // @ts-ignore
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign(__assign({ onScroll: function () {
        ...
        // @ts-ignore
        [emit,];
    } }, { class: "w97-scroll" }), { ref: (__VLS_ctx.setScrollRef) }));
...
for (var _b = 0, _c = __VLS_vFor((__VLS_ctx.columns)); _b < _c.length; _b++) {
    ...
    var _loop_1 = function (item) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.li, __VLS_intrinsics.li)(__assign(__assign(__assign(__assign(__assign({ onClick: function () {
                ...
                var $event = _a[0];
                __VLS_ctx.emit('item-click', { id: item.name, event: $event });
                // @ts-ignore
                ...
                var $event = _a[0];
                __VLS_ctx.emit('item-contextmenu', { id: item.name, event: $event });
                // @ts-ignore
                [emit,];
            } }), { key: (item.name) }), { class: "w97-li w97-li-row" }), { class: ({ active: __VLS_ctx.selectedIds.includes(item.name), 'detail-row': __VLS_ctx.listMode === 'detail' }) }), { ref: (function (el) { return __VLS_ctx.setItemRef(item.name, el); }) }));
        /** @type {__VLS_StyleScopedClasses['w97-li']} */ ;
        /** @type {__VLS_StyleScopedClasses['w97-li-row']} */ ;
        /** @type {__VLS_StyleScopedClasses['active']} */ ;
        /** @type {__VLS_StyleScopedClasses['detail-row']} */ ;
        if (__VLS_ctx.listMode === 'detail') {
            __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign(__assign({ class: "cell-name name-col" }, { style: ({ width: __VLS_ctx.colWidths.name + 'px' }) }), { title: (item.name) }));
            /** @type {__VLS_StyleScopedClasses['cell-name']} */ ;
            /** @type {__VLS_StyleScopedClasses['name-col']} */ ;
            (item.displayName);
            ...
            __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)(__assign(__assign({ class: "name-only" }, { style: ({ width: __VLS_ctx.colWidths.name + 'px' }) }), { title: (item.name) }));
