<template>
  <section class="page">
    <div class="recipe-test-shell">
      ...
      <Win97ContextMenu :open="ctxMenu.open" :x="ctxMenu.x" :y="ctxMenu.y" :items="ctxMenu.items" />
      <Win97ConfirmDialog :open="confirmModal.open" :title="confirmModal.title" :tone="confirmModal.tone" :message="confirmModal.message" @yes="confirmYes" @no="confirmNo" />
