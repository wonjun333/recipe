...
exports.recipeFileOpsApi = void 0;
function http(path, init) {
    return __awaiter(this, void 0, void 0, function () {
        var res, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, fetch(path, __assign({ headers: { 'Content-Type': 'application/json' } }, init))];
                case 1:
                    res = _b.sent();
...
exports.recipeFileOpsApi = {
    saveAs: function (body) {
