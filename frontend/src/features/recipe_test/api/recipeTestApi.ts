...
export type HistoryRevisionValue = { id?: number; valueSeq?: number; componentKey?: string; componentLabel?: string; unit?: string; beforeValue?: string; afterValue?: string; beforeText?: string; afterText?: string; sourceParamKey?: string }
export type HistoryRevision = { id?: number; revisionId?: number; seqNo?: number; reviseColumn?: string; reviseIndex?: number; displayBefore?: string; displayAfter?: string; values?: HistoryRevisionValue[] }
export type HistoryEntry = { id?: number; historyId?: number; actorName: string; actorTeam: string; fromEqpId: string; action: string; toEqpId: string; createdAt: string; itemKind?: string; sourceName?: string; targetName?: string; recipeName?: string; requestId?: string; status?: string; reason?: string; detail?: string; knoxid?: string; fromEqpTeam?: string; toEqpTeam?: string; revisions?: HistoryRevision[] }
