...
export const mockEqpOptions: EqpOptionsResponse = {
  items: [
...
export const mockLoadResponse: LoadResponse = {
  eqpId: 'CMP-A01',
...
export const mockCasContent: CasContentResponse = {
  casId: 'MAIN.cas',
  slots: [
...
export const mockJobContent: JobContentResponse = {
  jobId: 'JOB-001',
...
export const mockHistoryItems: HistoryEntry[] = [
  {
    actorName: 'Kim Minsu',
    actorTeam: 'CMP1',
    fromEqpId: 'CMP-A01',
